    ...
    function Te(e, r, t, n, i, u) {
      {
        ...
        if (!o) {
          ...
          d ? a += d : a += he();
          var s;
          e === null ? s = "null" : q(e) ? s = "array" : e !== void 0 && e.$$typeof === w ? (s = "<" + (y(e.type) || "Unknown") + " />", a = " Did you accidentally export a JSX literal instead of a component?") : s = typeof e, f("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", s, a);
        }
        var l = Qe(e, r, t, i, u);
        if (l == null)
          return l;
...
var dr = Z.exports;
function pr() {
  return /* @__PURE__ */ dr.jsx("button", { className: "bg-red-200 text-xl", children: "Click me hello" });
}
export {
  pr as Button
};
