...
>(({ className, variant = 'default', trianglePosition = 'center', ...props }, ref) => {
  ...
  React.useEffect(() => {
    console.log(`DialogSystem position: x=${x}, y=${y}, strategy=${strategy}`)
  }, [x, y, strategy])
  ...
  return (
    <div className="absolute z-50 justify-center" ref={refs.setReference}>
      <div className="" ref={refs.setFloating} style={{ position: strategy, top: y + 10 ?? 0, left: x ?? 0 }}>
        <div
          ref={ref}
          role="alert"
